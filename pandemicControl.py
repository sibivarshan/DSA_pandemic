...
def main():
    ...
    '''ensuring that medical supplies are pre-positioned in multiple locations to avoid reliance on single points of failure'''
    # Finding and printing bridges
    bridges = city_graph.findBridges()
    print("Bridges in the city graph:", bridges)

    # Finding and printing articulation points
    ...
    state_graph.supplyState(4000,"StateA")

    print("SHORTEST PATH TO REACH A CITY FROM MED-CITY:")
    print("\n")
    print(state_graph.reachAllCities("StateA"))
    print("\n")
